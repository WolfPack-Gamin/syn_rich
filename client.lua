...
Citizen.CreateThread(function()
	while true do
        ...
        SetDiscordRichPresenceAction(0, "Join Discord", Config.discordlink) -- copy and paste if u want new buttons, change 0 to the next number, so the next button would be 1 then 2 etc
